...
int main()
{
    ...
    while (running)
    {
        ...
        if (KTPSekarang->isAdmin)
        {
            cout << "-----------------------------------" << endl;
            cout << "7. [ADMIN] Tambah Lagu" << endl;
            cout << "8. [ADMIN] Hapus Lagu" << endl;
        }
        ...
        else if (m == 7 && KTPSekarang->isAdmin)
        {
            ...
            musicLib.addSong(title, artist, duration, filePath);
            musicLib.saveMusic("listMusic.txt");
            system("pause");
        }
        else if (m == 8 && KTPSekarang->isAdmin)
        {
            // Menu Admin: Hapus Lagu
            cout << "\n=== HAPUS LAGU ===" << endl;
            musicLib.displayAll();
